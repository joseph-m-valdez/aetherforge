// Package main implements a low-level, zero-dependency MAVLink packet parser.
//
// 🛠️ ARCHIVE NOTE & PORTFOLIO PIECE:
// This package is intentionally preserved to demonstrate a foundational understanding 
// of the MAVLink protocol specification. It showcases manual byte stream decoding, 
// frame synchronization (seeking the 0xFE/0xFD magic markers), payload bitmasking, 
// and custom X25 CRC checksum validation without relying on external abstractions.
//
// For the production-ready, library-supported implementation, see: mavsniff/main.go
package main
